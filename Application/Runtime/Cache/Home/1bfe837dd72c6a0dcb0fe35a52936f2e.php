      ...
      <div class="col-lg-10"><!-- right content -->
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title">Order id - <?php echo ($order["id"]); ?></h3>
          </div>
          <div class="panel-body">
            <p>Placement Time: <?php echo ($order["place_date"]); ?></p>
            <p>Order Status:</p>
            <p>Total Amount: CDN$ <?php echo ($order["total_price"]); ?></p>
            <p>Total Items: <?php echo ($order["total_qty"]); ?></p>
            <p>- Item List -</p>
            
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><table class="table table-hover">
              <tr>
                <th>Product</th>
                <th>Price</th>
                <th>Qty</th>
              ...
              <tr>
                <td><a href="<?php echo U('Product/view', array('productId'=>$vo['id']));?>"><?php echo ($vo["brand"]); ?> - <?php echo ($vo["product_name"]); ?></a></td>
                <td>CND $ <?php echo ($vo["price"]); ?></td>
          ...
          <div class="panel-footer">
            <a href="<?php echo U('Order/orderList');?>" class="btn btn-primary">Back to My orders</a>
            <a href="" class="btn btn-primary">Order cancel request</a>
          </div>
        </div>
      </div><!-- right content -->
